...
def point():
    while True: #This is not the full functionality. The projection functionality needs to be implemented. For now we will point the camera.
        ...
        continue_pointing = input("Continue pointing? (Y/n)")
        if continue_pointing != "Y":
            break
